...
export function ServicesHero() {
  return (
    <section className="relative pt-32 pb-20 overflow-hidden" aria-label="Services hero">
      ...
      <div className="absolute top-[45%] left-[55%] -translate-x-1/2 -translate-y-1/2 w-[550px] h-[550px] rounded-full bg-teal/[0.05] blur-[130px] pointer-events-none" />
      <div className="absolute top-[65%] left-[25%] w-[300px] h-[300px] rounded-full bg-terracotta/[0.03] blur-[100px] pointer-events-none" />
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 text-center bg-white/5 ring-1 ring-white/15 rounded-3xl py-8 md:py-10 backdrop-blur-sm">
        ...
        <motion.h1
          ...
          className="text-4xl md:text-5xl lg:text-6xl font-serif text-white leading-tight heading-tight drop-shadow-[0_4px_18px_rgba(0,0,0,0.45)]"
        >
          Services That Build
          <br />
