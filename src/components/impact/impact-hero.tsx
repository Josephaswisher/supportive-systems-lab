...
export function ImpactHero() {
  return (
    <section className="relative pt-32 pb-20 overflow-hidden bg-gradient-to-b from-cream via-white to-cloud" aria-label="Impact hero">
      <div className="absolute top-[40%] left-[60%] -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] rounded-full bg-teal/[0.08] blur-[120px] pointer-events-none" />
      <div className="absolute top-[70%] left-[30%] w-[350px] h-[350px] rounded-full bg-terracotta/[0.06] blur-[100px] pointer-events-none" />
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 text-center bg-white/75 ring-1 ring-navy/10 rounded-3xl py-8 md:py-10 backdrop-blur-sm">
        <motion.span
          variants={heroVariants}
          initial="hidden"
          animate="visible"
          className="inline-block text-navy text-sm uppercase tracking-[0.25em] font-semibold mb-4"
        >
          Case Study
        </motion.span>
        <motion.h1
