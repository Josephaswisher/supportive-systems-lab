  ...
  return (
    <SectionWrapper bg="cloud">
      <SectionHeading
        ...
        subtitle="We're working with organizations across the Triangle to build lasting impact."
      />

      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
        {[1, 2, 3].map((i) => (
          <FadeIn key={i} delay={i * 0.1}>
            <div className="bg-white/60 rounded-2xl p-8 border border-fog/50 text-center opacity-60">
              <div className="w-12 h-12 rounded-full bg-fog mx-auto mb-4" />
