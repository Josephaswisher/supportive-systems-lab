  ...
  return (
    <SectionWrapper bg="white">
      <SectionHeading
        ...
        subtitle="Every engagement follows the same proven three-step framework."
      />
            ...
            <motion.div key={step.title} variants={fadeUpVariants}>
              <div className="grid grid-cols-1 md:grid-cols-12 gap-6 md:gap-12 items-center py-12">
                ...
                <div className="md:col-span-1 flex md:flex-col items-center gap-4">
                  <div className="w-16 h-16 rounded-full bg-teal text-white flex items-center justify-center font-serif text-2xl shrink-0">
                    {step.step}
                  </div>
                  {idx < PROCESS_STEPS.length - 1 && (
                    <div className="hidden md:block w-0.5 h-24 bg-teal/20 mx-auto mt-4" />
                  )}
                </div>

                {/* Content */}
                <div className="md:col-span-11 bg-white rounded-2xl p-8 border border-fog shadow-sm">
