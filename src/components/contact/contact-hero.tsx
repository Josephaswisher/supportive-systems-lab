...
export function ContactHero() {
  return (
    <section className="relative pt-24 sm:pt-32 pb-16 sm:pb-20 overflow-hidden">
      ...
      <div className="absolute top-[50%] left-[40%] -translate-x-1/2 -translate-y-1/2 w-[250px] h-[250px] sm:w-[350px] sm:h-[350px] md:w-[450px] md:h-[450px] rounded-full bg-teal/[0.05] blur-[120px] pointer-events-none" />
      <div className="absolute top-[60%] right-[25%] w-[180px] h-[180px] sm:w-[250px] sm:h-[250px] md:w-[300px] md:h-[300px] rounded-full bg-terracotta/[0.03] blur-[100px] pointer-events-none" />
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 text-center bg-white/5 ring-1 ring-white/15 rounded-2xl sm:rounded-3xl py-6 sm:py-8 md:py-10 backdrop-blur-sm">
        ...
        <motion.h1
          ...
          className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-serif text-white leading-tight drop-shadow-[0_4px_18px_rgba(0,0,0,0.45)]"
        >
        ...
        <motion.p
          ...
          className="mt-4 sm:mt-6 text-white/95 text-base sm:text-lg font-medium max-w-2xl mx-auto leading-relaxed drop-shadow-[0_2px_10px_rgba(0,0,0,0.35)]"
        >
