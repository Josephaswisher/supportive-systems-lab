...
export function AboutHero() {
  return (
    <section className="relative pt-32 pb-20 overflow-hidden">
      ...
      <div className="absolute top-1/2 left-1/3 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] rounded-full bg-teal/[0.05] blur-[120px] pointer-events-none" />
      <div className="absolute top-[60%] right-[20%] w-[300px] h-[300px] rounded-full bg-terracotta/[0.03] blur-[100px] pointer-events-none" />
